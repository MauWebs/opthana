...
const SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      "<Autenticación para tus clientes />",
    ]
  },
  {
    ...
    items: [
      ...
      "Dashboards móviles y apps internas",
      ...
      <div className="relative z-20 mx-auto w-full px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem]">
        <div className="isolate grid grid-cols-1 gap-x-10 gap-y-16 sm:grid-cols-[14.5rem_1fr] sm:gap-y-24 lg:grid-cols-[20rem_1fr] lg:gap-x-20 lg:gap-y-40 xl:grid-cols-[24rem_1fr] xl:gap-x-0 xl:gap-y-6">
          <div className="col-span-full max-w-lg sm:justify-self-center sm:text-center xl:col-auto xl:text-left">
            ...
            <p className="mb-3 mt-4 text-[14px] text-[#5e5f6e]/90" style={{ lineHeight: '1.5rem' }} >Nos encargamos de crear sistemas para empresas, desde webs corporativas hasta sistemas automatizados y apps móviles, convirtiendo visitantes en ventas constantes.</p>
                ...
                >
                  ...
                  >
                    <div className="col-start-1 row-start-1">
                      <p className="text-pretty pl-4 text-[12px] text-[#5e5f6e]">{service.description}</p>
                      <ul role="list" className="mt-1.5 pl-4">
                        {service.items.map((item, itemIndex) => (
                          <li key={itemIndex}>
                            <button
                              className={`block w-full py-3 text-left soehne-mono-500 text-[12px] transition-colors ${itemIndex === 0 ? "text-[#6c47ff]" : "text-[#131316]/80 hover:text-[#131316]/40 duration-500"}`}
                              data-rac=""
                              type="button"
                              tabIndex={0}
                              data-react-aria-pressable="true"
