      ...
      <div className="relative isolate overflow-hidden bg-gray-50 pb-60 pt-[calc(theme(spacing.16)+theme(spacing.20))] sm:-mt-[10px] sm:pb-101 sm:pt-[calc(theme(spacing.16)+theme(spacing.32))] select-none">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-30">
          <div className="text-center mx-auto w-full px-6 sm:max-w-[40rem] md:max-w-[48rem] md:px-8 lg:max-w-[64rem] xl:max-w-[80rem] mt-[63px]">
            <h1 className="mx-auto max-w-[17.5rem] text-balance text-3xl/9  tracking-tight text-[#131316] sm:!max-w-4xl sm:text-4.5xl md:text-5xl lg:text-6xl [@media(width&gt;=27.5em)]:max-w-[24.25rem]"
            ...
            >Desarrollo de Software y Aplicaciones para Empresas</h1>
            <p className="mx-auto mt-4 max-w-md text-pretty text-gray-600 sm:max-w-[800px] sm:text-[18px]" style={{ lineHeight: '1.75rem;' }}>
