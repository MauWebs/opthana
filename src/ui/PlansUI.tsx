...
export default function PlansUI({ shadowBorder = true, border = false, removeMarginBottom = false, showShine = true }: { shadowBorder?: boolean; border?: boolean; removeMarginBottom?: boolean; showShine?: boolean }) {
  const [isYearly, setIsYearly] = useState(true);

  return (
    <div className={`relative overflow-hidden flex flex-1 flex-row rounded-lg h-[20rem] ${!removeMarginBottom ? "mb-[16px]" : ""} ${border ? "border border-gray-200" : ""}`} style={{
