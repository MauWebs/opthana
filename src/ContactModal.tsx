              ...
              <div className="-mt-4">
                <div>
                  ...
                  <div className="mt-4 border-t border-gray-200 pt-3 flex items-center justify-between text-[11px] text-[#7a7a8a]/90">
                   ...
                   <a
  href="https://wa.me/54223539559?text=Hola,%20me%20interesaría%20realizar%20un%20desarrollo%20o%20plataforma!"
  target="_blank"
  rel="noopener noreferrer"
  className="text-[#236dd7] underline hover:opacity-80 transition"
>
  WhatsApp
              ...
              <>
                <div className="flex flex-col -gap-[1px] -mt-4">
                  <p className="text-[12px] text-gray-500 mt-3">Completa el formulario o contáctanos por nuestras redes.</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <a target="_blank" href="https://wa.me/54223539559?text=Hola,%20me%20interesaría%20realizar%20un%20desarrollo%20o%20plataforma!" className="group relative flex h-8 items-center justify-center gap-2 rounded-md bg-white text-[12px] text-[#000]/35 [text-shadow:0_0_0.01px_currentColor] transition-all duration-150 hover:bg-[#F3F4F6]" style={{ boxShadow: "rgba(0, 0, 0, 0.08) 0px 0px 0px 1px, rgba(0, 0, 0, 0.02) 0px 1px 0px 0px, rgba(0, 0, 0, 0.08) 0px 2px 3px -1px" }}>
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[12px] text-gray-500">Nombre completo</label>
                  <input
                    name="contact_name"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[12px] text-gray-500">Correo electrónico</label>
                  <input
                    name="contact_email"
                    autoComplete="new-password"
                    autoCorrect="off"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[12px] text-gray-500">Como podemos ayduarte?</label>
                  <textarea
